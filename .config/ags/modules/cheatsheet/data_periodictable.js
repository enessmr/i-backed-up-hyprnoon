export const periodicTable = [
    ...
    [
        ...
        { name: 'Oxygen', symbol: 'O', number: 8, weight: 16.00, type: 'nonmetal' },
        { name: 'Fluorine', symbol: 'F', number: 9, weight: 19.00, type: 'nonmetal' },
    ...
    [
        { name: 'Potassium', symbol: 'K', number: 19, weight: 39.10, type: 'metal' },
        { name: 'Calcium', symbol: 'Ca', number: 20, weight: 40.08, type: 'metal' },
        { name: 'Scandium', symbol: 'Sc', number: 21, weight: 44.96, type: 'metal' },
        { name: 'Titanium', symbol: 'Ti', number: 22, weight: 47.87, type: 'metal' },
        { name: 'Vanadium', symbol: 'V', number: 23, weight: 50.94, type: 'metal' },
        { name: 'Chromium', symbol: 'Cr', number: 24, weight: 52.00, type: 'metal', icon: 'chromium-symbolic' },
        ...
        { name: 'Germanium', symbol: 'Ge', number: 32, weight: 72.63, type: 'metalloid' },
        { name: 'Arsenic', symbol: 'As', number: 33, weight: 74.92, type: 'metalloid' },
        { name: 'Selenium', symbol: 'Se', number: 34, weight: 78.96, type: 'nonmetal' },
        { name: 'Bromine', symbol: 'Br', number: 35, weight: 79.90, type: 'nonmetal' },
        { name: 'Krypton', symbol: 'Kr', number: 36, weight: 83.80, type: 'noblegas' },
    ],
    [
        ...
        { name: 'Technetium', symbol: 'Tc', number: 43, weight: 98.00, type: 'metal' },
        ...
        { name: 'Antimony', symbol: 'Sb', number: 51, weight: 121.76, type: 'metalloid' },
        { name: 'Tellurium', symbol: 'Te', number: 52, weight: 127.60, type: 'metalloid' },
        { name: 'Iodine', symbol: 'I', number: 53, weight: 126.90, type: 'nonmetal' },
    ...
    [
        ...
        { name: 'Lanthanum', symbol: 'La', number: 57, weight: 138.91, type: 'lanthanide' },
        ...
        { name: 'Lead', symbol: 'Pb', number: 82, weight: 207.20, type: 'metal' },
        { name: 'Bismuth', symbol: 'Bi', number: 83, weight: 208.98, type: 'metal' },
        { name: 'Polonium', symbol: 'Po', number: 84, weight: 209.00, type: 'metalloid' },
        { name: 'Astatine', symbol: 'At', number: 85, weight: 210.00, type: 'metalloid' },
        { name: 'Radon', symbol: 'Rn', number: 86, weight: 222.00, type: 'noblegas' },
    ],
    [
        { name: 'Francium', symbol: 'Fr', number: 87, weight: 223, type: 'metal' },
        { name: 'Radium', symbol: 'Ra', number: 88, weight: 226, type: 'metal' },
        { name: 'Actinium', symbol: 'Ac', number: 89, weight: 227, type: 'actinide' },
...
export const series = [
    [
        ...
        { name: '', symbol: '', number: -1, weight: 0, type: 'empty' },
        { name: '', symbol: '', number: -1, weight: 0, type: 'empty' },
        { name: 'Cerium', symbol: 'Ce', number: 58, weight: 140.12, type: 'lanthanide' },
        { name: 'Praseodymium', symbol: 'Pr', number: 59, weight: 140.91, type: 'lanthanide' },
        { name: 'Neodymium', symbol: 'Nd', number: 60, weight: 144.24, type: 'lanthanide' },
        { name: 'Promethium', symbol: 'Pm', number: 61, weight: 145, type: 'lanthanide' },
        { name: 'Samarium', symbol: 'Sm', number: 62, weight: 150.36, type: 'lanthanide' },
        { name: 'Europium', symbol: 'Eu', number: 63, weight: 151.96, type: 'lanthanide' },
        { name: 'Gadolinium', symbol: 'Gd', number: 64, weight: 157.25, type: 'lanthanide' },
        { name: 'Terbium', symbol: 'Tb', number: 65, weight: 158.93, type: 'lanthanide' },
        { name: 'Dysprosium', symbol: 'Dy', number: 66, weight: 162.50, type: 'lanthanide' },
        { name: 'Holmium', symbol: 'Ho', number: 67, weight: 164.93, type: 'lanthanide' },
        { name: 'Erbium', symbol: 'Er', number: 68, weight: 167.26, type: 'lanthanide' },
        { name: 'Thulium', symbol: 'Tm', number: 69, weight: 168.93, type: 'lanthanide' },
        { name: 'Ytterbium', symbol: 'Yb', number: 70, weight: 173.04, type: 'lanthanide' },
        { name: 'Lutetium', symbol: 'Lu', number: 71, weight: 174.97, type: 'lanthanide' },
        { name: '', symbol: '', number: -1, weight: 0, type: 'empty' },
    ],
    [
        { name: '', symbol: '', number: -1, weight: 0, type: 'empty' },
        { name: '', symbol: '', number: -1, weight: 0, type: 'empty' },
        { name: '', symbol: '', number: -1, weight: 0, type: 'empty' },
        { name: 'Thorium', symbol: 'Th', number: 90, weight: 232.04, type: 'actinide' },
        { name: 'Protactinium', symbol: 'Pa', number: 91, weight: 231.04, type: 'actinide' },
        { name: 'Uranium', symbol: 'U', number: 92, weight: 238.03, type: 'actinide' },
        { name: 'Neptunium', symbol: 'Np', number: 93, weight: 237, type: 'actinide' },
        { name: 'Plutonium', symbol: 'Pu', number: 94, weight: 244, type: 'actinide' },
        { name: 'Americium', symbol: 'Am', number: 95, weight: 243, type: 'actinide' },
        { name: 'Curium', symbol: 'Cm', number: 96, weight: 247, type: 'actinide' },
        { name: 'Berkelium', symbol: 'Bk', number: 97, weight: 247, type: 'actinide' },
        { name: 'Californium', symbol: 'Cf', number: 98, weight: 251, type: 'actinide' },
        { name: 'Einsteinium', symbol: 'Es', number: 99, weight: 252, type: 'actinide' },
        { name: 'Fermium', symbol: 'Fm', number: 100, weight: 257, type: 'actinide' },
        { name: 'Mendelevium', symbol: 'Md', number: 101, weight: 258, type: 'actinide' },
        { name: 'Nobelium', symbol: 'No', number: 102, weight: 259, type: 'actinide' },
        { name: 'Lawrencium', symbol: 'Lr', number: 103, weight: 262, type: 'actinide' },
        { name: '', symbol: '', number: -1, weight: 0, type: 'empty' },
    ],
];
